...
import { Search, Plus, Edit, Package, Truck, Building, FileText, Download } from 'lucide-react';
...
const OrderManagement = () => {
  ...
  const products = [
    { id: 'P001', name: 'iPhone 15 Pro', category: 'Electronics', price: 999.99, stock: 245 },
    { id: 'P002', name: 'Samsung Galaxy S24', category: 'Electronics', price: 899.99, stock: 156 },
    { id: 'P003', name: 'MacBook Pro 16"', category: 'Electronics', price: 2499.99, stock: 89 },
    { id: 'P004', name: 'Dell XPS 13', category: 'Electronics', price: 1299.99, stock: 134 },
    { id: 'P005', name: 'iPad Pro 12.9"', category: 'Electronics', price: 1099.99, stock: 78 }
  ];
...
${orderProducts.map((product, index) => {
  ...
  return `${index + 1}. ${productInfo?.name || 'Unknown Product'} - Quantity: ${product.quantity}${product.notes ? ` - Notes: ${product.notes}` : ''}`;
}).join('\n')}
  ...
  return (
    <div className="order-management" >
      <div className="order-header">
        <h1 style={{ color: "orangered", fontSize: "40px" , textDecoration:"none" }}>Order Management</h1>
      ...
      <div className="order-content">
        <div className="content-header">
          <h2>{orderType === 'outbound' ? 'Outbound' : 'Inbound'} Order Management</h2>
        ...
        <div className="modal-overlay" onClick={() => setShowOrderModal(false)}>
          <div className="modal large" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>Create {orderType === 'outbound' ? 'Outbound' : 'Inbound'} Order</h2>
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form className="update-form">
              ...
              <div className="form-group">
                ...
                <select defaultValue={selectedCompany?.type} className="form-input">
              ...
              <div className="form-group">
                <label>Status</label>
                <select defaultValue={selectedCompany?.status} className="form-input">
